...
public class MainClass {
	...
	// 어플리케이션 실행시 
	// jvm이 수많은 클래스 중에 제일 처음 찾아가는 메서드 
	// 프로젝트이름에 우클릭하고 실행(run as-java application) 누르면 여러 main이 다 뜸
	// 어떤 메서드를 이용해서 프로젝트를 처음 실행을 할까요?
	public static void main(String[] args) {
		
		// 아직 DB 안 배웠으므로 배열로 처리
